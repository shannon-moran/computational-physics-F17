...
def figure56_test(process,n,edge_densities,replicates):
    for replicate in range(replicates):
        ...
        for density in edge_densities:
            ...
            Sample.build()
            largest_scc.append(ranked_SCC(nx.strongly_connected_components(matrix_to_nx(Sample.edges)))/n)
...
def figure8(process,n,edge_densities):
    ...
    plt.title('%s process: SCC combination near critical edge density' % process)
